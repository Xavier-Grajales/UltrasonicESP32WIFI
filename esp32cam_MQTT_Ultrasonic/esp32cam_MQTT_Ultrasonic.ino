/*
 * Lectura de sensor ultrasonico HC-SR04 con el ESP32CAM y MQTT
 * por: Xavier Grajales
 * Fecha: 01 de Octubre del 2021.
 * 
 * Este programa ee el sensor ultrasonico con la biblioteca de Erick Simoe.
 * En su versión 3.0.0 se mezcla con el programa  ESP32CAM-MQTT basic del respositorio de 
 * Codigo-iot
 * 
 ...
 * y usar NodeRed para visualizar que la información que se está recibiendo es correcta
 * 
 * 
...
Ultrasonic ultrasonic(pinTrigger, pinEcho);//objeto que maneja el sensor
